...
* Probes exposed via Actuator at
...
To simplify the versioning, a new branch is created for each version (e.g. `3.4`).
...
digraph G {
        ...
        node[group=3.3];
        1 -> 2 -> 3 -> 4 -> 11;
        3[shape=cds,label="3.3.0"];
        11[shape=box,label=3.3];
        node[group=3.4];
        2 -> 6 -> 7 -> 8 -> 9 -> 10;
        10[shape=box,label=3.4];
        6[shape=cds,label="3.4.0"];
        7[shape=cds,label="3.4.1"];
}
@enddot
----

A version is a branch (e.g. `3.4`) and a release is a tag (e.g. `3.4.1`).
...
The `3.4.0` version of `acme-spring-boot` depends on `spring-boot:3.4`.
